...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference("Box.count") do
      post boxes_url, params: { box: { hectare: @box.hectare, name: @box.name, quality: @box.quality, weigth: @box.weigth } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { hectare: @box.hectare, name: @box.name, quality: @box.quality, weigth: @box.weigth } }
